...
$(document).ready(function () {
    ...
    function getTextFieldHTML() {
        ...
        return $('<div>').addClass('li_ form_builder_field').html(html);
    }
    ...
    function getPreview(codview = '') {
        ...
        if (codview === 'html') {		//프리뷰를 보여주게하고(html이 널이아니면)
            $('.preview').hide();
            $('.codview').show().find('textarea').val(html);
        } else {
            $('.codview').hide();
